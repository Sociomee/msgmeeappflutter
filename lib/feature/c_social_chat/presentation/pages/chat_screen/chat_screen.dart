...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    context.read<ChatRoomsCubit>().getchatRoomMessages(id: widget.id!);
                    ...
                    ? AppBar(
                        ...
                        actions: [
                          ...
                          GestureDetector(
                              ...
                              child: SvgPicture.asset('assets/reply.svg',
                                  height: 18)),
                          SizedBox(width: 19),
                        ],
                      )
                  ...
                  children: [
                    context.watch<SetChatbgCubit>().state.bgType ==
                        ...
                        ? Container(
                            ...
                            color:
                                context.read<SetChatbgCubit>().state.bgContent)
                        : context.watch<SetChatbgCubit>().state.bgType ==
                    ...
                    if (state.messages.room != null)
                      GestureDetector(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: state.messages.room!.messages!.length,
                          shrinkWrap: true,
                          ...
                          itemBuilder: (context, index) {
                            return Align(
                              alignment: (authorId !=
                                      state.messages.room!.messages![index]
                                          .author!.sId
                                  ? Alignment.topLeft
                                  : Alignment.topRight),
                              child: authorId !=
                                          ...
                                          child: Stack(
                                            children: [
                                              ReceivedMessageWidget(
                                                message: state.messages.room!
                                                    .messages![index].content!,
                                                msgStatus: '',
                                                time: state.messages.room!
                                                    .messages![index].date!
                                                  ...
                                                  if (messageController
                                                    ...
                                                    context
                                                        ...
                                                        : context
                                                            ...
                                                            //               .text,
                                                            //     ));
                                                            : context.read<ChatRoomsCubit>().sendMessage(
                                                                authorId: state
                                                                        .userId ??
                                                                    '',
                                                                roomId:
